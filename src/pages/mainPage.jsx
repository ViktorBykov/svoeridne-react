    ...
    <div className="main-page">
      <div className="main-screen container">
        ...
        <div className="main-screen-col right">
          <img src={mainBg} className="main-screen-bg" alt="main screen background" />
        </div>
        <img className="main-screen-left-bg" src={mainLeftBg} alt="main screen background" />
        <img className="main-screen-right-bg" src={mainRightBg} alt="main screen background" />
      </div>
