    ...
    <div className="catalog-item-page">
      <div className="container">
        ...
        <div className="item-details">
          ...
          <p>
            <img src={name} alt="name" className="item-details-icon" />
            <span>{sellerName}</span>
          </p>
          <p>
            <img src={phone} alt="phone" className="item-details-icon" />
            <a className="phone-link" href={`tel:${sellerPhone}`}>
              {sellerPhone}
            </a>
          </p>
          <p>
            <img src={location} alt="location" className="item-details-icon" />
